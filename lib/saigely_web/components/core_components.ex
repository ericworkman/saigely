defmodule SaigelyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SaigelyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SaigelyWeb.Gettext, "errors", msg, opts)
    end
  end
